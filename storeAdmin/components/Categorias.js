class Categorias extends HTMLElement{
    ...
    renderHTML(){
        this.shadowRoot.innerHTML = `
            <style>${Categorias.styleCss}</style>
            <section class="main-content">
                <header class="header">
                    <h2 class="title">Categorias</h2>
                    <button class="button-agg" id="addButton">Agregar Categoria</button>
                </header>
    ...
    codeJS(){
        ...
        addButton.addEventListener("click", () => {
            modalTitle.textContent = "Agregar Categoria"; 
        ...
        shadow.addEventListener("click", (event) => {
            if (event.target.classList.contains("btn-update")) {
                ...
                modalTitle.textContent = "Actualizar Categoria";
...
customElements.define('comp-categorias', Categorias);